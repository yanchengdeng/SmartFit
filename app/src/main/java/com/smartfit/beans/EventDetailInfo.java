...
public class EventDetailInfo {
    ...
    private String eventStartTime;//1459180800,
    ...
    public List<com.smartfit.beans.newest2Events> getNewest2Events() {
        return newest2Events;
    }

    public void setNewest2Events(List<com.smartfit.beans.newest2Events> newest2Events) {
