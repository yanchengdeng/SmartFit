package com.smartfit.views.pathmenu;
...
//        drawable = ctx.getDrawable(R.drawable.ic_cancel);
        drawable = ctx.getResources().getDrawable(R.mipmap.icon_home);
...
//        drawable = cxt.getDrawable(R.drawable.icon_home);
        invalidate();
    }
...
//            setOutlineProvider(outlineProvider);
    ...
    private void calculateMenuItemPosition() {
        ...
        float itemRadius = (expandedRadius+collapsedRadius)*3 /5f;//change the items radias
