    ...
    public static class Builder {
        ...
        public Builder inflate(int menuResId) {
            ...
            for (int i = 0; i < menu.size(); i++) {
                ...
                addItem(item.getIcon(),item.getTitle().toString());
            }
            menu.clear();
            menu = null;
            popupMenu = null;
        ...
        public Builder addItem(Drawable icon,String text) {
            View view = inflater.inflate(R.layout.menu_item, null, false);
            ImageView imageButton =    (ImageView) view.findViewById(R.id.img_icon);
...
//            view.setBackgroundResource(value.resourceId);
        ...
        public Builder addItem(int iconResId,String name) {
