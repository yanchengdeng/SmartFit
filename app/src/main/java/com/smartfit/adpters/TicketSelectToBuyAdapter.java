 ...
 * 卷分享
 */
public class TicketSelectToBuyAdapter extends BaseAdapter {


    private List<UseableEventInfo> datas;
    private Context context;

    public TicketSelectToBuyAdapter(Context context, List<UseableEventInfo> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UseableEventInfo item = datas.get(position);
    ...
    public void setData(List<UseableEventInfo> datas) {
        this.datas = datas;
