 ...
 * 认证 适配器
 */
public class GridViewAuthAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<String> photos;

    public GridViewAuthAdapter(Context context, ArrayList<String> photos) {
        this.photos = photos;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.adapter_gird_auth_photo_item, null);
